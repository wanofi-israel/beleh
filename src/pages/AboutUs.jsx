  ...
  return (
    ...
    <div className='about-us_page hero'>
      <div className="content">
        ...
        <h1>
           Founded on<br /> a Passion for <br /> 
           
        </h1>
           <div className='sliding-word'>
            <div className="slider">
             <div className="first gradient-text">Music</div> <div className="second gradient-text">Brand Distinction.</div> <div className="first gradient-text">Music</div> <div className="second gradient-text">Brand Distinction.</div>
             </div>
            </div>
      </div>
